...
namespace Fegmm.ChurchTools.Finance.Reports.Statement.Costcenters.Item
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fegmm.ChurchTools.Finance.Reports.Statement.Costcenters.Item.WithCostCenterPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Fegmm.ChurchTools.Finance.Reports.Statement.Costcenters.Item.WithCostCenterPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Fegmm.ChurchTools.Finance.Reports.Statement.Costcenters.Item.WithCostCenterPostRequestBody();
        }
        /// <summary>
