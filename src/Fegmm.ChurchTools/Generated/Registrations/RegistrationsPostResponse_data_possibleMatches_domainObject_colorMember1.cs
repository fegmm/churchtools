...
namespace Fegmm.ChurchTools.Registrations
{
    ...
    public partial class RegistrationsPostResponse_data_possibleMatches_domainObject_colorMember1 : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public RegistrationsPostResponse_data_possibleMatches_domainObject_colorMember1()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fegmm.ChurchTools.Registrations.RegistrationsPostResponse_data_possibleMatches_domainObject_colorMember1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Fegmm.ChurchTools.Registrations.RegistrationsPostResponse_data_possibleMatches_domainObject_colorMember1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Fegmm.ChurchTools.Registrations.RegistrationsPostResponse_data_possibleMatches_domainObject_colorMember1();
        }
        /// <summary>
