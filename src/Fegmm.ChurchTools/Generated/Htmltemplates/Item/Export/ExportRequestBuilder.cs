...
namespace Fegmm.ChurchTools.Htmltemplates.Item.Export
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportGetResponse?> GetAsExportGetResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportGetResponse> GetAsExportGetResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Fegmm.ChurchTools.Htmltemplates.Item.Export.ExportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
