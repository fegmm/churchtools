...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_calendar? Calendar { get; set; }
#nullable restore
#else
        public global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_calendar Calendar { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventFiles>? EventFiles { get; set; }
#nullable restore
#else
        public List<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventFiles> EventFiles { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventServices>? EventServices { get; set; }
#nullable restore
#else
        public List<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventServices> EventServices { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "eventFiles", n => { EventFiles = n.GetCollectionOfObjectValues<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventFiles>(global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventFiles.CreateFromDiscriminatorValue)?.AsList(); } },
                { "eventServices", n => { EventServices = n.GetCollectionOfObjectValues<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventServices>(global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventServices.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventFiles>("eventFiles", EventFiles);
            writer.WriteCollectionOfObjectValues<global::Fegmm.ChurchTools.Persons.Item.Events.EventsGetResponse_data_eventServices>("eventServices", EventServices);
