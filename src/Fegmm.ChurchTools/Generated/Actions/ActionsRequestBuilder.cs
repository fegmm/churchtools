...
namespace Fegmm.ChurchTools.Actions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Fegmm.ChurchTools.Actions.ActionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Fegmm.ChurchTools.Actions.ActionsPostResponse?> PostAsActionsPostResponseAsync(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Fegmm.ChurchTools.Actions.ActionsPostResponse> PostAsActionsPostResponseAsync(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Fegmm.ChurchTools.Actions.ActionsResponse?> PostAsync(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Fegmm.ChurchTools.Actions.ActionsResponse> PostAsync(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Fegmm.ChurchTools.Actions.ActionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fegmm.ChurchTools.Actions.ActionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Fegmm.ChurchTools.Actions.ActionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Fegmm.ChurchTools.Actions.ActionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
