...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_bookings>? Bookings { get; set; }
#nullable restore
#else
        public List<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_bookings> Bookings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_events>? Events { get; set; }
#nullable restore
#else
        public List<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_events> Events { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_meta? Meta { get; set; }
#nullable restore
#else
        public global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "bookings", n => { Bookings = n.GetCollectionOfObjectValues<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_bookings>(global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_bookings.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "events", n => { Events = n.GetCollectionOfObjectValues<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_events>(global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_events.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "meta", n => { Meta = n.GetObjectValue<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_meta>(global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_bookings>("bookings", Bookings);
            ...
            writer.WriteCollectionOfObjectValues<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_events>("events", Events);
            ...
            writer.WriteObjectValue<global::Fegmm.ChurchTools.Calendars.Appointments.Templates.Item.WithTemplateGetResponse_data_meta>("meta", Meta);
